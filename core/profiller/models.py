...
class Profil(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name="profil") # user.profil ile direkt profile ulaşmamızı sağlayacak 
    ...
    def save(self, *args, **kwargs):
        ...
        if self.foto:
            ...
            if img.height > 600 or img.width > 600:
                autputh_size = (600,600)
                img.thumbnail(autputh_size)
